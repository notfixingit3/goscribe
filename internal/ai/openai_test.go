...
func TestNewOpenAIClient_DefaultModel(t *testing.T) {
	client := NewOpenAIClient("sk-test", "", 0)
	if client == nil {
		t.Fatal("expected client, got nil")
	}
	if client.model != "gpt-4" {
		t.Fatalf("expected default model 'gpt-4', got %q", client.model)
	}
...
func TestNewOpenAIClient_CustomModel(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-3.5-turbo", 0)
	if client.model != "gpt-3.5-turbo" {
		t.Fatalf("expected model 'gpt-3.5-turbo', got %q", client.model)
	}
}

func TestNewOpenAIClient_WithTimeout(t *testing.T) {
	timeout := 30 * time.Second
	client := NewOpenAIClient("sk-test", "gpt-4", timeout)
	if client.timeout != timeout {
		t.Fatalf("expected timeout %v, got %v", timeout, client.timeout)
	}
}

func TestOpenAIClient_Generate_ContextTimeout(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 1*time.Millisecond)
...
func TestOpenAIClient_enhanceError_Nil(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
...
func TestOpenAIClient_enhanceError_Timeout(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 30*time.Second)
...
func TestOpenAIClient_enhanceError_Auth(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
...
func TestOpenAIClient_enhanceError_RateLimit(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
...
func TestOpenAIClient_enhanceError_Quota(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
	err := client.enhanceError(errors.New("insufficient_quota"))
	if err == nil {
		t.Fatal("expected error")
	}
...
func TestOpenAIClient_enhanceError_ModelNotFound(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !strings.Contains(err.Error(), `model "gpt-4" not found`) {
...
func TestOpenAIClient_enhanceError_ContextLength(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
	err := client.enhanceError(errors.New("maximum context length exceeded"))
	if err == nil {
		t.Fatal("expected error")
	}
...
func TestOpenAIClient_enhanceError_ServerError(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
...
func TestOpenAIClient_enhanceError_NetworkError(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
...
func TestOpenAIClient_enhanceError_Unknown(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
	...
	if !strings.Contains(err.Error(), "openai error:") {
		t.Fatalf("expected generic openai error, got: %v", err)
	}
}

func TestOpenAIClient_enhanceError_CaseInsensitive(t *testing.T) {
	client := NewOpenAIClient("sk-test", "gpt-4", 0)
...
func TestOpenAIClient_ProviderInterface(t *testing.T) {
